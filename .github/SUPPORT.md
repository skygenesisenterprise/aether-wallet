...
Thank you for using **Aether Wallet** — an open-source wallet client developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
If you're using the open-source version of Aether Wallet and need help with:
...
- 💬 [GitHub Discussions](https://github.com/skygenesisenterprise/aether-wallet/discussions)
- 🐞 [GitHub Issues](https://github.com/skygenesisenterprise/aether-wallet/issues) – for bug reports only
...
Want to help improve Aether Wallet?  
